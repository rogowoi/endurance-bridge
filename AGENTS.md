...
13. Restart or reload Codex after configuration changes. Verify the server using `codex mcp get endurance-bridge` and `pnpm mcp:check`.
...
- The user's Codex installation discovers the MCP tools.
